...
const ProjectSection: React.FC = () => {
  return (
    <section id="portfolio" className="py-24 px-4">
      {/* OUTER CONTAINER */}
      <div className="w-[90%] mx-auto rounded-[10px] border border-[#7ea383]/15 bg-[#242d22] p-6 sm:p-8 md:p-12">

        {/* Heading */}
        <div className="text-center max-w-2xl mx-auto">
          <span className="inline-flex mb-6 items-center px-5 py-2 text-sm font-semibold tracking-wider text-[#7ea383] uppercase">
            Our Work
          </span>
        ...
        <div className="w-full md:w-[85%] mx-auto rounded-[10px] p-4 sm:p-8 md:p-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
            ...
            <div className="lg:col-span-8">
              <div className="h-full min-h-[240px] overflow-hidden rounded-[10px] border border-[#7ea383]/15">
                <img
          ...
          <div className="text-center mt-14">
            <Link
              href="https://www.techgenixsolutions.com/#"
              className="inline-flex items-center gap-2 bg-[#7faabb] px-9 py-4 rounded-lg text-[#1c221a] font-semibold hover:bg-[#5f8a9b] transition duration-300"
            >
              View All Projects
            </Link>
          </div>
...
const ProjectCard = ({ project }: { project: Project }) => {
  return (
    <div className="group rounded-[10px] overflow-hidden border border-[#7ea383]/15 bg-[#F0F4F0]/5 hover:bg-[#7ea383]/10 transition-all duration-300 hover:-translate-y-1 flex flex-col h-full">

      {/* TEXT */}
      <div className="p-5 sm:p-6 flex flex-col gap-2 flex-1">
        {/* Category badge */}
        <span className="self-start text-xs font-semibold px-3 py-1 rounded-full bg-[#7ea383]/10 border border-[#7ea383]/25 text-[#7ea383] tracking-wide mb-1">
          {project.category}
        </span>
        <h3 className="text-lg sm:text-xl font-semibold text-[#F0F4F0] group-hover:text-[#7faabb] transition-colors duration-300 leading-snug">
      ...
      <div className="relative overflow-hidden shrink-0">
        ...
        <Link
          href={project.href}
          className="absolute top-4 right-4 text-[#7ea383] text-xl opacity-0 group-hover:opacity-100 transition duration-300 bg-[#1c221a]/70 rounded-full p-2"
        >
          <FiArrowUpRight />
        </Link>
      </div>
